    ...
    <section id="teachers-page" class="pt-90 pb-120 gray-bg">
        <div class="container">
           <div class="row">
            ...
            $sqlBook = "SELECT Image, Name, Department FROM Teachers ORDER By ID DESC";
            ...
            if ($resultBook->num_rows > 0) {
                ...
                while($row = $resultBook->fetch_assoc()) {
                    $itemImage = $row['Image'];
                    $itemName = $row['Name'];
                    $itemDepartment = $row['Department'];
                    echo'
                   <div class="col-lg-3 col-sm-6">
                       <div class="singel-teachers mt-30 text-center">
                            <div class="image">
                                <img src="data:image/jpeg;base64,'.base64_encode($itemImage).'" alt="Teachers">
                            </div>
                            <div class="cont">
                                <a href="teachers-singel.php?teacherName='.$itemName.'"><h6>'.$itemName.'</h6></a>
