<?php
session_start();
$univerName = $_GET['universityName'];
$univerID;
$univerLink;
$univerImage;
$univerDescription;
...
$sql = "SELECT ID, Image, Name, Link, Description, Requirement, StaffNum, DepartmentNum FROM Universities WHERE Name = '$univerName'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        $univerID = $row['ID'];
        $univerLink = $row['Link'];
        $univerImage = $row['Image'];
        $univerDescription = $row['Description'];
        $univerReq = $row['Requirement'];
        $univerStaff = $row['StaffNum'];
        $univerDepart = $row['DepartmentNum'];    
    }
}
?>
<!doctype html>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2><?php echo $univerName; ?></h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="university.php">Universities</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $univerName; ?></li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        <div class="title">
                            <h3><?php echo $univerName; ?></h3>
                        </div> <!-- title -->
                        
                        
                        <div class="corses-singel-image pt-50">
                            <?php echo'<img src="data:image/jpeg;base64,'.base64_encode($univerImage).'">';?>
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="singel-description pt-40">
                                            <h6>University Summery</h6>
                                            <p><?php echo $univerDescription; ?></p>
                                        </div>
                                        <div class="singel-description pt-40">
                                            <h6>Requrements</h6>
                                            <p><?php echo $univerReq; ?></p>
                                        </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               <h4>Course Features </h4>
                                <ul>
                                    <li><i class="fa fa-clone"></i>Department Number : <span><?php echo $univerDepart; ?></span></li>
                                    <li><i class="fa fa-user-o"></i>Staff Number :  <span><?php echo $univerStaff; ?></span></li>
                                </ul>
                                <div class="price-button pt-10" >
                                    <?php 
                                    if ($_SESSION['utype'] == "student"){
                                        echo '<a target="_blank" href="'.$univerLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>'; 
                                        echo '<a href="php/addFavoriteUniversity.php?itemName='.$univerName.'&itemType=university&itemWriter=empty&page=university-singel.php" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 24%;">Add Favorite</a>';
                                    }else{
                                        echo '<a target="_blank" href="'.$univerLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>'; 
                                    }
