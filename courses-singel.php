...
$sql = "SELECT Name, Teacher, AboutTeacher, Category, Image, Summery, Requirements, Duration, Quizzes, Lectures, Students, Link FROM Courses WHERE Name = '$courseName'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        $courseTeacher=$row['Teacher'];
        $courseAboutTeacher=$row['AboutTeacher'];
        $courseCategory=$row['Category'];
        $courseImage=$row['Image'];
        $courseSummery=$row['Summery'];
        $courseRequirements=$row['Requirements'];
        $courseDuration=$row['Duration'];
        $courseQuizzes=$row['Quizzes'];
        $courseLectures=$row['Lectures'];
        $courseStudents=$row['Students'];
        $courseLink=$row['Link'];   
    }
}
?>
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="singel-description pt-40">
                                            ...
                                            <p><?php echo $courseSummery; ?></p>
                                        </div>
                                        <div class="singel-description pt-40">
                                            <h6>Requrements</h6>
                                            <p><?php echo $courseRequirements; ?></p>
                                        </div>
                                    ...
                                    <div class="instructor-cont">
                                        <div class="instructor-author">
                                            <div class="author-name">
                                                <a ><h5><?php echo $courseTeacher; ?></h5></a>
                                                <span><?php echo $courseCategory; ?></span>
                                            </div>
                                        </div>
                                        <div class="instructor-description pt-25">
                                            <p><?php echo $courseAboutTeacher; ?></p>
                                        </div>
                                    </div> <!-- instructor cont -->
                                </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               <h4>Course Features </h4>
                                <ul>
                                    <li><i class="fa fa-clock-o"></i>Duaration : <span><?php echo $courseDuration; ?></span></li>
                                    <li><i class="fa fa-clone"></i>Leactures : <span><?php echo $courseLectures; ?></span></li>
                                    <li><i class="fa fa-beer"></i>Quizzes :  <span><?php echo $courseQuizzes; ?></span></li>
                                    <li><i class="fa fa-user-o"></i>Students :  <span><?php echo $courseStudents; ?></span></li>
                                </ul>
                                <div class="price-button pt-10">
                                    <?php 
                                    if ($_SESSION['utype']=="student"){
                                        echo '<a target="_blank" href="'.$courseLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>'; 
                                        echo '<a href="php/addFavoriteCourses.php?itemName='.$courseName.'&itemType=course&itemWriter=empty&page=courses-singel.php" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 24%;">Add Favorite</a>';
                                    }else{
                                        echo '<a target="_blank" href="'.$courseLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>'; 
                                    }
