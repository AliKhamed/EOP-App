    ...
    <div class="col-lg-12">
                    <div class="teachers-right mt-50">
                        <ul class="nav nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="active" id="addcourse-tab" data-toggle="tab" href="#addcourse" role="tab" aria-controls="addcourse" aria-selected="false">Add Course</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="addcourse" role="tabpanel" aria-labelledby="addcourse-tab">
