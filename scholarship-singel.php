<?php
session_start();
$scholarshipName = $_GET['scholarshipsityName'];
$scholarshipLink;
$scholarshipImage;
...
$sql = "SELECT Image, Description, Link, Requirment, Duration, Students FROM Scholarships WHERE Name = '$scholarshipName'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        $scholarshipLink = $row['Link'];
        $scholarshipImage = $row['Image'];
        $scholarshipDescription = $row['Description'];
        $scholarshipReq = $row['Requirment'];
        $scholarshipStudent = $row['Students'];
        $scholarshipDuration = $row['Duration']; 
    }
}
?>
<!doctype html>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2><?php echo $scholarshipName; ?></h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="scholarship.php">scholarships</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $scholarshipName; ?></li>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        ...
                        <div class="corses-singel-image pt-50">
                            <?php echo'<img src="data:image/jpeg;base64,'.base64_encode($scholarshipImage).'">';?>
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="singel-description pt-40">
                                            <h6>scholarship Summery</h6>
                                            <p><?php echo $scholarshipDescription; ?></p>
                                        </div>
                                        <div class="singel-description pt-40">
                                            <h6>Requrements</h6>
                                            <p><?php echo $scholarshipReq; ?></p>
                                        </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               <h4>Course Features </h4>
                                <ul>
                                    <li><i class="fa fa-clone"></i>Duration : <span><?php echo $scholarshipDuration; ?></span></li>
                                    <li><i class="fa fa-user-o"></i>Students Number :  <span><?php echo $scholarshipStudent; ?></span></li>
                                </ul>
                                <div class="price-button pt-10" >
                                    <?php 
                                    if ($_SESSION['utype']=="student"){
                                        echo '<a target="_blank" href="'.$scholarshipLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>'; 
                                        echo '<a href="php/addFavoriteScholarship.php?itemName='.$scholarshipName.'&itemType=scholarship&itemWriter=empty&page=scholarship-singel.php" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 24%;">Add Favorite</a>';
                                    }else{
                                        echo '<a target="_blank" href="'.$scholarshipLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>';
                                    }
                                     ?>
