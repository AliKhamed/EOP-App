	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-02.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            	...
            	<br>
				<form class="login100-form validate-form" action="php/editprofile.php" method="POST" >
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<?php echo'<input class="input100" type="text" name="username" placeholder="'.$_SESSION['uname'].'">';?>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Useremail is reauired">
						...
						<?php echo'<input class="input100" type="text" name="useremail" placeholder="'.$_SESSION['uemail'].'">';?>
						<span class="focus-input100" data-symbol="&#xf200;"></span>
					</div>
