...
$sql = "SELECT Image, Department, About, Mobile, Email FROM Teachers WHERE Name = '$teacherName'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        $teacherImage = $row['Image'];
        $teacherDepartment = $row['Department'];
        $teacherAbout = $row['About'];
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $teacherName; ?></li>
                            </ol>
                        </nav>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="teachers-left mt-50">
                        <div class="hero">
                            <?php echo'<img src="data:image/jpeg;base64,'.base64_encode($teacherImage).'">';?>
                        </div>
                        <div class="name">
                            <h6><?php echo $teacherName;?></h6>
                            <span><?php echo $teacherDepartment;?></span>
                        </div>
