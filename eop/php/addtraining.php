...
if (isset($_POST['add'])) { // if save button on the form is clicked
    ...
    $sql = "INSERT INTO Training (Name, Link, Description, Requirement , Duration, Trainers, Image) VALUES ('$name', '$link', '$description', '$requirement', '$duration', '$trainersNum', '$image')";
