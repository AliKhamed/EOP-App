...
$sql = "SELECT Image, Name, Link, Description, Requirement, Students, Duration FROM Masters WHERE Name = '$masterName'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        $masterLink = $row['Link'];
        $masterImage = $row['Image'];
        $masterDescription = $row['Description'];
        $masterReq = $row['Requirement'];
        $masterStudent = $row['Students'];
        $masterDuration = $row['Duration'];    
    }
}
?>
<!doctype html>
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $masterName; ?></li>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        ...
                        <div class="corses-singel-image pt-50">
                            <?php echo'<img src="data:image/jpeg;base64,'.base64_encode($masterImage).'">';?>
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="singel-description pt-40">
                                            <h6>Master Summery</h6>
                                            <p><?php echo $masterDescription; ?></p>
                                        </div>
                                        <div class="singel-description pt-40">
                                            <h6>Requrements</h6>
                                            <p><?php echo $masterReq; ?></p>
                                        </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               <h4>Course Features </h4>
                                <ul>
                                    <li><i class="fa fa-clone"></i>Duration : <span><?php echo $masterDuration; ?></span></li>
                                    <li><i class="fa fa-user-o"></i>Students Number :  <span><?php echo $masterStudent; ?></span></li>
                                </ul>
                                <div class="price-button pt-10" >
                                    <?php
                                    if ($_SESSION['utype']=="student"){
                                        echo '<a target="_blank" href="'.$masterLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>'; 
                                    echo '<a href="php/addFavoriteMasters.php?itemName='.$masterName.'&itemType=master&itemWriter=empty&page=masters-singel.php" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 24%;">Add Favorite</a>';
                                    }else{
                                        echo '<a target="_blank" href="'.$masterLink.'" class="main-btn" style="position: center;vertical-align:middle;text-align:center;margin-right: 27%;">Enroll Now</a>'; 
                                    } 
