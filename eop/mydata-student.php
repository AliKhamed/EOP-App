                ...
                <div class="col-lg-10">
                    <div class="teachers-right mt-50">
                        <ul class="nav nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="active" id="universities-tab" data-toggle="tab" href="#universities" role="tab" aria-controls="universities" aria-selected="true">Universities</a>
                            </li>
                            <li class="nav-item">
                                <a id="scholarships-tab" data-toggle="tab" href="#scholarships" role="tab" aria-controls="scholarships" aria-selected="false">Scholarships</a>
                            </li>
                            <li class="nav-item">
                                <a id="courses-tab" data-toggle="tab" href="#courses" role="tab" aria-controls="courses" aria-selected="false">Courses</a>
                            </li>
                            <li class="nav-item">
                                <a id="books-tab" data-toggle="tab" href="#books" role="tab" aria-controls="books" aria-selected="false">Books</a>
                            </li>
                            <li class="nav-item">
                                <a id="masters-tab" data-toggle="tab" href="#masters" role="tab" aria-controls="masters" aria-selected="false">Masters</a>
                            </li>
                            <li class="nav-item">
                                <a id="trainings-tab" data-toggle="tab" href="#trainings" role="tab" aria-controls="trainings" aria-selected="false">Trainings</a>
                            </li>
                            <li class="nav-item">
                                <a id="events-tab" data-toggle="tab" href="#events" role="tab" aria-controls="events" aria-selected="false">Event</a>
                            </li>
                        </ul> <!-- nav -->
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="courses-grid" role="tabpanel" aria-labelledby="courses-grid-tab">
                                                    <div class="row">
                                                            ...
                                                            $sqlBook = "SELECT ItemName FROM Favorite WHERE Type='university' AND User='$user' ORDER By ID DESC";
                                                                        ...
                                                                        <div class="col-lg-4 col-md-6">
                                                                            <div class="singel-course mt-30">
                                                                                <div class="cont">
                                                                                    ...
                                                                                    <span>(20 Reviws)</span>-->
                                                                                    <a href="university-singel.php?universityName='.$itemName.'"><h4>'.$itemName.'</h4></a>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="courses-grid" role="tabpanel" aria-labelledby="courses-grid-tab">
                                                    <div class="row">
                                                            ...
                                                            $user = $_SESSION['uemail'];
                                                            $sqlBook = "SELECT ItemName FROM Favorite WHERE Type='scholarship' AND User='$user'  ORDER By ID DESC";
                                                            $resultBook = $connBook->query($sqlBook);
                                                            if ($resultBook->num_rows > 0) {
                                                                // output data of each row
                                                                while($row = $resultBook->fetch_assoc()) {
                                                                        ...
                                                                        <div class="col-lg-4 col-md-6">
                                                                            <div class="singel-course mt-30">
                                                                                <div class="cont">
                                                                                    ...
                                                                                    <span>(20 Reviws)</span>-->
                                                                                    <a href="scholarship-singel.php?scholarshipsityName='.$itemName.'"><h4>'.$itemName.'</h4></a>
                                                                                    <!--<div class="course-teacher">
                                                                                        <div class="thum">
                                                                                            <a href="#"><img src="images/course/teacher/t-1.jpg" alt="teacher"></a>
                                                                                        </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="courses-grid" role="tabpanel" aria-labelledby="courses-grid-tab">
                                                    <div class="row">
                                                            ...
                                                            $user = $_SESSION['uemail'];
                                                            $sqlBook = "SELECT ItemName FROM Favorite WHERE Type='course' AND User='$user' ORDER By ID DESC";
                                                            $resultBook = $connBook->query($sqlBook);
                                                            if ($resultBook->num_rows > 0) {
                                                                // output data of each row
                                                                while($row = $resultBook->fetch_assoc()) {
                                                                        ...
                                                                        <div class="col-lg-4 col-md-6">
                                                                            <div class="singel-course mt-30">
                                                                                <div class="cont">
                                                                                    ...
                                                                                    <span>(20 Reviws)</span>-->
                                                                                    <a href="courses-singel.php?courseName='.$itemName.'"><h4>'.$itemName.'</h4></a>
                                                                                    <!--<div class="course-teacher">
                                                                                        <div class="thum">
                                                                                            <a href="#"><img src="images/course/teacher/t-1.jpg" alt="teacher"></a>
                                                                                        </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="courses-grid" role="tabpanel" aria-labelledby="courses-grid-tab">
                                                   <div class="row">
                                                            ...
                                                            $user = $_SESSION['uemail'];
                                                            $sqlBook = "SELECT ItemName, ItemWriter FROM Favorite WHERE Type='book' AND User='$user'  ORDER By ID DESC";
                                                            $resultBook = $connBook->query($sqlBook);
                                                            if ($resultBook->num_rows > 0) {
                                                                // output data of each row
                                                                while($row = $resultBook->fetch_assoc()) {
                                                                    $itemName = $row['ItemName'];
                                                                    $itemWriter = $row['ItemWriter'];
                                                                    echo '
                                                                        <div class="col-lg-4 col-md-6">
                                                                            <div class="singel-course mt-30">
                                                                                <div class="cont">
                                                                                    ...
                                                                                    <span>(20 Reviws)</span>-->
                                                                                    <a href="book-singel.php?bookname='.$itemName.'&bookwriter='.$itemWriter.'"><h4>'.$itemName.'</h4></a>
                                                                                    <!--<div class="course-teacher">
                                                                                        <div class="thum">
                                                                                            <a href="#"><img src="images/course/teacher/t-1.jpg" alt="teacher"></a>
                                                                                        </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="courses-grid" role="tabpanel" aria-labelledby="courses-grid-tab">
                                                    <div class="row">
                                                            ...
                                                            $user = $_SESSION['uemail'];
                                                            $sqlBook = "SELECT ItemName, ItemWriter FROM Favorite WHERE Type='master' AND User='$user'  ORDER By ID DESC";
                                                            $resultBook = $connBook->query($sqlBook);
                                                            if ($resultBook->num_rows > 0) {
                                                                // output data of each row
                                                                while($row = $resultBook->fetch_assoc()) {
                                                                        ...
                                                                        <div class="col-lg-4 col-md-6">
                                                                            <div class="singel-course mt-30">
                                                                                <div class="cont">
                                                                                    ...
                                                                                    <span>(20 Reviws)</span>-->
                                                                                    <a href="masters-singel.php?mastersName='.$itemName.'"><h4>'.$itemName.'</h4></a>
                                                                                    <!--<div class="course-teacher">
                                                                                        <div class="thum">
                                                                                            <a href="#"><img src="images/course/teacher/t-1.jpg" alt="teacher"></a>
                                                                                        </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="courses-grid" role="tabpanel" aria-labelledby="courses-grid-tab">
                                                    <div class="row">
                                                            ...
                                                            $user = $_SESSION['uemail'];
                                                            $sqlBook = "SELECT ItemName, ItemWriter FROM Favorite WHERE Type='training' AND User='$user'  ORDER By ID DESC";
                                                            $resultBook = $connBook->query($sqlBook);
                                                            if ($resultBook->num_rows > 0) {
                                                                // output data of each row
                                                                while($row = $resultBook->fetch_assoc()) {
                                                                        ...
                                                                        <div class="col-lg-4 col-md-6">
                                                                            <div class="singel-course mt-30">
                                                                                <div class="cont">
                                                                                    ...
                                                                                    <span>(20 Reviws)</span>-->
                                                                                    <a href="training-singel.php?trainingName='.$itemName.'"><h4>'.$itemName.'</h4></a>
                                                                                    <!--<div class="course-teacher">
                                                                                        <div class="thum">
                                                                                            <a href="#"><img src="images/course/teacher/t-1.jpg" alt="teacher"></a>
                                                                                        </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="courses-grid" role="tabpanel" aria-labelledby="courses-grid-tab">
                                                    <div class="row">
                                                            ...
                                                            $user = $_SESSION['uemail'];
                                                            $sqlBook = "SELECT ItemName FROM Favorite WHERE Type='event'  AND User='$user' ORDER By ID DESC";
                                                            $resultBook = $connBook->query($sqlBook);
                                                            if ($resultBook->num_rows > 0) {
                                                                // output data of each row
                                                                while($row = $resultBook->fetch_assoc()) {
                                                                    ...
                                                                    $sqlBook = "SELECT EDate FROM Event WHERE Name='$itemName'";
                                                                    $resultBook = $connBook->query($sqlBook);
                                                                    if ($resultBook->num_rows > 0) {
                                                                        // output data of each row
                                                                        while($row = $resultBook->fetch_assoc()) {
                                                                                    ...
                                                                                    <div class="col-lg-4 col-md-6">
                                                                                        <div class="singel-course mt-30">
                                                                                            <div class="cont">
                                                                                                ...
                                                                                                <span>(20 Reviws)</span>-->
                                                                                                <a href="events-singel.php?eventname='.$itemName.'&eventdate='.$itemDate.'"><h4>'.$itemName.'</h4></a>
                                                                                                <!--<div class="course-teacher">
                                                                                                    <div class="thum">
                                                                                                        <a href="#"><img src="images/course/teacher/t-1.jpg" alt="teacher"></a>
                                                                                                    </div>
