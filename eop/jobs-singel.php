...
$sql = "SELECT Image, Title, Link, Description, Requirement, Mobile, Email FROM Jobs WHERE Title = '$jobName'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $jobReq = $row['Requirement'];
        $jobMobile = $row['Mobile'];
        $jobEmail = $row['Email'];    
    }
}
?>
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $jobName; ?></li>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        ...
                        <div class="corses-singel-image pt-50">
                            <?php echo'<img src="data:image/jpeg;base64,'.base64_encode($jobImage).'">';?>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               <h4>Course Features </h4>
                                <ul>
                                    <li><i class="fa fa-phone"></i>Mobile : <span><?php echo $jobMobile; ?></span></li>
                                    <li><i class="fa fa-envelope"></i>Email :  <span><?php echo $jobEmail; ?></span></li>
                                </ul>
                                <div class="price-button pt-10" >
                                    <?php echo '<a target="_blank" href="'.$jobLink.'" class="main-btn">Login</a>'; ?>
                                </div>
                            </div> <!-- course features -->
                        </div>
                    </div>
