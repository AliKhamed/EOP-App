                ...
                <div class="col-lg-8">
                    <div class="teachers-right mt-50">
                        <ul class="nav nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="active" id="dashboard-tab" data-toggle="tab" href="#dashboard" role="tab" aria-controls="dashboard" aria-selected="true">My Data</a>
                            </li>
                            <!--<li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="dashboard-cont">
                                    ...
                                    <div class="singel-dashboard pt-40">
                                        <h5>Email</h5>
                                        <p><?php echo $_SESSION['uemail'];?></p>
                                    </div> <!-- singel dashboard -->
                                    <div class="singel-dashboard pt-40">
                                        <h5>Type</h5>
                                        <p><?php echo $_SESSION['utype'];?></p>
                                    </div> <!-- singel dashboard -->
                                    <div class="singel-dashboard pt-40">
                                        <button class="main-btn"><a href="login/editProfile.php" style="color: inherit;">Edit</a></button>
                                    </div> <!-- singel dashboard -->
                                </div> <!-- dashboard cont -->
                            </div>
