                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            ...
                            <div class="button float-left">
                                <a href="Login/index.html" class="main-btn">Login</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- row -->
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="courses.html">Undergraduate</a>
                                        <ul class="sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="courses.html">Postgraduate</a>
                                        <ul class="sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="teachers.html">Our Staff</a>
                                        <ul class="sub-menu">
            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="about-cont">
                        ...
                        <a href="about.html" class="main-btn mt-55">Learn More</a>
                    </div>
                </div> <!-- about cont -->
                        ...
                        <ul>
                            <li>
                                <div class="singel-event">
                                    <span><i class="fa fa-calendar"></i> 2 March 2020</span>
                                    <a ><h4>Campus clean workshop</h4></a>
                                    <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                                    <span><i class="fa fa-map-marker"></i> Louxor University </span>
                                </div>
                            </li>
                            <li>
                                <div class="singel-event">
                                    <span><i class="fa fa-calendar"></i> 20 April 2020</span>
                                    <a ><h4>Tech Summit</h4></a>
                                    <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                                    <span><i class="fa fa-map-marker"></i> Greek Campus </span>
                                </div>
                            </li>
                            <li>
                                <div class="singel-event">
                                    <span><i class="fa fa-calendar"></i> 12 December 2020</span>
                                    <a "><h4>Enviroement conference</h4></a>
                                    <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                ...
                                <div class="admin">
                                    <ul>
                                        <li><a><i class="fa fa-user"></i><span>31</span></a></li>
                                        <li><a><i class="fa fa-heart"></i><span>10</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(20 Reviws)</span>
                            <a href="courses-singel.html"><h4>Learn social media from start for beginner</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(30 Reviws)</span>
                            <a href="courses-singel.html"><h4>Mobile development course from start</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(40 Reviws)</span>
                            <a href="courses-singel.html"><h4>Learn basis english from start for beginner</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(50 Reviws)</span>
                            <a href="courses-singel.html"><h4>Learn basis digital business marketing</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-6 col-md-4 col-sm-5">
                    <div class="products-btn text-right pb-60">
                        <a href="books.html" class="main-btn">All Books</a>
                    </div> <!-- products btn -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="book-singel.html"><h6>Set for life </h6></a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="book-singel.html"><h6>A Daughters </h6></a>
                                <span>By Scott Trench</span>
                            </div>
                            <div class="button text-right">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="book-singel.html"><h6>A Magnet </h6></a>
                                <span>By Scott Trench</span>
                            </div>
                            <div class="button text-right">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        ...
                        <div class="cont">
                            <div class="name">
                                <a href="book-singel.html"><h6>Pices of light</h6></a>
                                <span>By Scott Trench</span>
                            </div>
                            <div class="button text-right">
                ...
                <div class="col-lg-6">
                    <div class="singel-news mt-30">
                        ...
                        <div class="news-cont">
                            ...
                            <a href="#"><h3>There is new scholarship you can apply on it.</h3></a>
                            <p>OP offers a number of scholarships, preferential rates and corporate discounts on tuition fees. Get more information and start your journey with us today .</p>
                        </div>
                    </div> <!-- singel news -->
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                                    ...
                                    <a href="#"><h3>Master for all</h3></a>
                                    <p>Master programmes you both deepen your professional skills and your knowledge in the area of General Management.</p>
                                </div>
                            </div>
                        </div> <!-- row -->
                    </div> <!-- singel news -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-link mt-40">
                            ...
                            <ul>
                                ...
                                <li><a href="courses.html"><i class="fa fa-angle-right"></i>Universities</a></li>
                                <li><a href="courses.html"><i class="fa fa-angle-right"></i>Scholarships</a></li>
                                <li><a href="courses.html"><i class="fa fa-angle-right"></i>Courses</a></li>
                            </ul>
                            <ul>
                                <li><a href="#"><i class="fa fa-angle-right"></i>Masters</a></li>
                                <li><a href="#"><i class="fa fa-angle-right"></i>Trainings</a></li>
                                <li><a href="#"><i class="fa fa-angle-right"></i>Jobs</a></li>
